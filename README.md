...
| 站点                               | 状态                                                                        | 说明                                 |
| ---------------------------------- | --------------------------------------------------------------------------- | ------------------------------------ |
| [Youtube](https://youtube.com)     | ![Build Status](https://github.com/axetroy/vd/workflows/youtube/badge.svg)  |                                      |
...
| [PornHub](https://pornhub.com)     | ![Build Status](https://github.com/axetroy/vd/workflows/pornhub/badge.svg)  |                                      |
...
```bash
deno install --unstable --allow-read --allow-write --allow-net -f https://github.com/axetroy/vd/raw/master/vd.ts
```
